...
static struct Value *fn_str(struct Value *v, struct Auto *stack) /*{{{*/
{
  ...
  String_new(&s);
  Value_toString(arg,&s,' ',-1,0,0,-1,0,0);
  v->type=V_STRING;
  v->u.string=s;
  return v;
}
...
/*}}}*/
static struct Value *fn_pininput(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,INPUT);
}
/*}}}*/
static struct Value *fn_pinoutput(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,OUTPUT);
}
/*}}}*/
static struct Value *fn_pinlow(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,LOW);
}
/*}}}*/
static struct Value *fn_pinhigh(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,HIGH);
}
/*}}}*/
static struct Value *fn_pin1(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,PIN1);
}
/*}}}*/
static struct Value *fn_pin2(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,PIN2);
}
/*}}}*/
static struct Value *fn_pin3(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,PIN3);
}
/*}}}*/
static struct Value *fn_pin4(struct Value *v, struct Auto *stack) /*{{{*/
{
  return Value_new_INTEGER(v,PIN4);
}
/*}}}*/
static struct Value *fn_lw_analogread(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
...
/*}}}*/
static struct Value *fn_lw_digitalread(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_open(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    lwHandle = littleWire_connect();  
  }
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_pinmode(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_pwminit(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_pwmstop(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_pwmupdatecompare(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_pwmupdateprescaler(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_i2cbegintransmission(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_i2cendtransmission(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
  i2c_endTransmission(lwHandle);
  return Value_new_INTEGER(v,-1);
}
/*}}}*/
static struct Value *fn_lw_i2cinit(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_i2crequestfrom(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_i2csend(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
...
/*}}}*/
static struct Value *fn_lw_servoupdatelocation(struct Value *v, struct Auto *stack) /*{{{*/
{
  if (lwHandle == NULL) {
    return Value_new_ERROR(v,IOERROROPEN,"Little Wire", "Little Wire could not be found!");
  }
