...
extern int Program_delete(struct Program *this, long int line);
...
extern struct Value *Program_list(struct Program *this, int dev, struct Pc *from, struct Pc *to, struct Value *value);
